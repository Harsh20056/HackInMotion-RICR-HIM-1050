...
const DEFAULT_FALLBACK_RESULT: FormAnalyzerResult = {
  ...
  guidance: {
    ...
    required_documents: [
      ...
      { name: "Income Proof", details: "Salary Certificate / Form 16 / ITR / Employer Certificate / Land Record" },
    ...
    filling_steps: [
      { step: 1, field: "Personal Details", instruction: "Fill applicant's full name, father/husband's name, gender, and date of birth exactly as printed on Aadhaar.", example: "RAMESH KUMAR" },
      { step: 2, field: "Address Information", instruction: "Enter complete permanent and current address with PIN code and District.", example: "Ward No. 4, Main Road, Bhopal, MP - 462001" },
      { step: 3, field: "Income Sources & Breakdown", instruction: "Specify annual income from salary, agriculture, business, rent, and other sources.", example: "Salary: ₹1,20,000, Agriculture: ₹30,000, Total: ₹1,50,000" },
      { step: 4, field: "Purpose of Certificate", instruction: "Check or mention the specific purpose (e.g. Scholarship, EWS Certificate, Admission).", example: "Higher Education Scholarship" },
      { step: 5, field: "Declaration & Signature", instruction: "Sign at the bottom of the declaration section with date and place.", example: null },
    ],
    submission: {
      where: "Tehsildar Office / Sub-Divisional Magistrate (SDM) Office / E-District Online Portal / Jan Seva Kendra / CSC Center",
    ...
    custom_query_answer: "This form requires income proof, Aadhaar card, residence proof, and a self-declaration affidavit. Verification is usually completed within 7 to 15 working days.",
    sources: [
      {
...
export const formAnalyzerService = {
  async analyze(opts: {
    ...
    if (!visionEnabled()) {
      logger.warn("Form analyzer called but no vision provider is configured, returning standard form guidance");
